    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="fp-controlArrow" style="color: white; left: 5px;"><i class="material-icons medium">keyboard_arrow_left</i></div><div class="fp-controlArrow" style="color: white; right: 130px"><i class="material-icons medium">keyboard_arrow_right</i></div>');
