    ...
    $.fn.fullpage = function (options) {
      ...
      function createSlideArrows(section) {
        section
          ...
          .after(
            '<div class="fp-controlArrow" style="color: white; left: 5px;"><i class="material-icons medium">keyboard_arrow_left</i></div><div class="fp-controlArrow right-arrow" style="color: white;"><i class="material-icons medium">keyboard_arrow_right</i></div>'
          );
      ...
      function addVerticalNavigation() {
        ...
        for (var i = 0; i < $(SECTION_SEL).length; i++) {
          ...
          var li =
            '<li><a href="#' +
            link +
            '"><span><i class="material-icons mat-icons">' +
            icon[i] +
            '</i></span></a>';
